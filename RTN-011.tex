...
Additional components include the release of nightly Processed Visit Images (PVIs) and associated Source catalogs during the first 2 years of the survey, leading up to Data Rele	ase 1 (DR1), which will be based on the first year of LSST observations. 
