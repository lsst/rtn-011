...
\setDocChangeRecord{%
  ...
  \addtohist{1}{2020-12-16}{Drft 1.1}{Bob Blum}
}
...
\input{intro}
<<<<<<< HEAD
\input{sciencedrivers}
\input{commissioning}
\input{alertproduction}
\input{alertproduction}
\input{metrics}
=======
\input{sciencedrivers}\label{sec:scidrive}
\input{commissioning}\label{sec:com}
\input{too}\label{sec:too}
\input{static}\label{sec:stat}
\input{alertproduction}\label{sec:pp}
\input{survey}
