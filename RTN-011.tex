...
\newcommand{\vrolsst}{Vera C.
Rubin Observatory Legacy Survey of Space and Time (LSST)\xspace}
...
% Import the parameters generated from yaml
\input{parameters}
...
\setDocChangeRecord{%
  ...
  \addtohist{9}{2022-10-24}{Changes to SCOC and survey text.
Release version 2.1}{Leanne Guy}
  \addtohist{10}{2022-11-16}{Clarifications on alert production during commissioning.
Release version 2.2}{Leanne Guy}
  \addtohist{11}{2023-01-10}{Updates following the construction project replan, refactoring of document to remove duplication.
Release version 3.}{Leanne Guy}
  ...
  \addtohist{19}{2025-02-10}{Major updates to the plans and data products for DP1.
Revision of the Alert Production section.
Release version 6.0}{Leanne Guy}
  \addtohist{20}{2025-02-24}{Minor updates to add more information on DP1 data products.
Release version 6.1}{Leanne Guy}
 ...
 \addtohist{22}{2025-08-19}{Create Rubin DOI}{T.
Jenness}
 ...
 \addtohist{25}{2025-11-11}{Fix minor typos, Release v7.1}{Leanne Guy}
 \addtohist{26}{2026-01-07}{Revise and update projected release dates,  Release v7.2}{Leanne Guy}
 \addtohist{27}{2026-01-21}{Update start of alerts date, Release v7.3}{Leanne Guy}
 \addtohist{28}{2026-02-02}{Update start of alerts date, Release v7.4}{Leanne Guy}
 \addtohist{29}{2026-04-15}{Update DP2 description, alerts  and schedule forrelease of PPDB, nightly images and catalogs. Release v8.0}{Eric Bellm, Melissa Graham, Leanne Guy}
 \addtohist{30}{2026-07-01}{Add EDP2 and release date; update PPDB and direct image schedule; include LSST start date.  Release v9.0}{Eric Bellm, Gregory Dubois-Felsmann, Lynne Jones, Leanne Guy}
}

% Optional set citation information
\setDocCitationInformation{ Leanne P. Guy, et al. Rubin Observatory Plans for an Early Science Program.
NSF-DOE Vera C. Rubin Observatory RTN-011, \url{https://doi.org/10.71929/rubin/2584021}.}
