...
Those plans include the release to the community of Rubin commissioning data products in the form of two Data Previews, the ramping up of the transient Alert stream, and the first LSST data release, DR1.
