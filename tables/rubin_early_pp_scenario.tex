...
{\renewcommand{\arraystretch}{1.3}
    ...
    \hline
    \multicolumn{3}{|l|}{{\large\color{RubinDarkTeal}\textbf{Rubin Early Alerts \& Prompt Products}}}  \\\hline\hline
\multirow{1}{*} {}  & 
        ...
        { \makecell{ \textbf{Commissioning (System } \\ \textbf{Optimization \& SV Surveys} }}  & 
