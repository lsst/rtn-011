...
\begin{tabular}{|
    ...
    \hline
 \multicolumn{62}{|l|}{ \color{RubinDarkTeal}\textbf{Rubin Operations Survey and Data Release Timeline}  } 
      \\ 
      
 \multicolumn{62}{|l|}{{\textbf{Nominal LSST Start Date: }August 2025}} 
      \\ \hline
%
