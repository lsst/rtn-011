...
\tiny Rubin First Alerts  (RFA)   &    \tiny  Jan -- Feb 2026 
   &   &  & &    & & &    &  &  &&  &  % 2025
...
\\\hline
%
\tiny PPDB Release (PPDB) &  Not before Jun 2026   
     &   &&&& &  &  &   & &   &  &    % 2025 
...
\\\hline
%
\tiny Data Preview 2  (DP2)  &    \tiny  Jul  -- Sep 2026      
    & & &&&&&&&&&& % 2025
...
%
\tiny Nightly PVIs \& Direct-Image Catalogs (NPC)  &  Not before July 2026   
     &   &&&& &  &  &   & &   &  &    % 2025 
     & & &  &&  &  & \cellcolor{TLOrange3} &&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
%
\tiny Start of LSST    (SVY)     &    \tiny Undefined     
     &   &&&& &  &  &   & &    &   &  % 2025 
    & &  & &  &  & &&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
%
\tiny Data Release  1 (DR1)  &    \tiny LSST start + 1 year 
   & & &&&&&&&&&&   % 2025
   &  & &&&&&&&&&&   % 2026
   & & &&& & && &  &  &    % 2027
      & & &&& & && &  &  &  % 2028
