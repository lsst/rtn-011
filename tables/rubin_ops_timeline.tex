...
\tiny Rubin First Alerts  (RFA)   &    \tiny  Jan 2026 -- Feb 2026 
   &   &  & &    & & &    &  &  &&  &  % 2025
     & \cellcolor{TLOrange2}  & \cellcolor{TLOrange3} &  &&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline

\tiny Start of LSST    (SVY)     &    \tiny Not before Feb 2026     
     &   &&&& &  &  &   & &    &   &  % 2025 
    & &  \cellcolor{TLOrange3} & \cellcolor{TLOrange3}  &  &  & &&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
%
\tiny Nightly PVIs \& Direct-Image Catalogs (NPC)  &  Not before Apr 2026   
     &   &&&& &  &  &   & &   &  &    % 2025 
...
\tiny Data Preview 2  (DP2)  &    \tiny  Jun 2026 -- Sep 2026      
    & & &&&&&&&&&& % 2025
    & &&  && & \cellcolor{TLOrange3} &\cellcolor{TLOrange2} &\cellcolor{TLOrange2}  &\cellcolor{TLOrange3} &&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
%
...
\tiny Data Release  1 (DR1)  &    \tiny Jan 2028 -- June 2028 
   ...
   &  & &&&&&&&&&&   % 2026
   & & &&& & && &  &  &    % 2027
   &  & \cellcolor{TLOrange3}   & \cellcolor{TLOrange3}  &  \cellcolor{TLOrange3} &  \cellcolor{TLOrange3}& \cellcolor{TLOrange3}&\cellcolor{TLOrange3}&&&&&&   % 2028
