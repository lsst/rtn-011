...
\begin{tabular}{|
    ...
    \hline
 \multicolumn{56}{|l|}{\fontsize{9}{12}\selectfont \color{RubinDarkTeal}\textbf{Rubin Operations Survey and Data Release Timeline}  } 
      \\ 
      
 \multicolumn{56}{|l|}{{\fontsize{7}{12}\selectfont \textbf{Nominal LSST Start Date: }August 2025}} 
      \\ \hline
%
...
\tiny Rubin First Light     &    \tiny Mar 2025 -- Apr 2025            
         &&&&&&   % 2024
   &   \cellcolor{TLOrange3} &  \cellcolor{TLOrange3} & \cellcolor{TLOrange2} &  \cellcolor{TLOrange2}   & \cellcolor{TLOrange3} &&&&&&&   % 2025
       & & &&&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
...
\tiny Data Preview 1    &    \tiny Apr 2025 -- May 2025         
    &  &&&  \cellcolor{TLOrange3} &  \cellcolor{TLOrange3} & \cellcolor{TLOrange3}   % 2024
     & \cellcolor{TLOrange2}  & \cellcolor{TLOrange2}  & \cellcolor{TLOrange2}  & \cellcolor{TLOrange2}   &\cellcolor{TLOrange2}   &\cellcolor{TLOrange2}  &  \cellcolor{TLOrange3} &&&&&   % 2025
       & & && &&&&&&&&  % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
...
\tiny Start of LSST    (SVY)     &    \tiny Jun 2025 -- Sep 2025       
         &&&&&&  % 2024
     &   &&&&\cellcolor{TLOrange3} &  \cellcolor{TLOrange3} & \cellcolor{TLOrange2} &  \cellcolor{TLOrange2}   & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange3} &   % 2025 
     & & &&&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
...
\tiny Data Preview 2   &    \tiny Dec 2025 -- Mar 2026      
    ...
    & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} &\cellcolor{TLOrange2} &\cellcolor{TLOrange2} &\cellcolor{TLOrange3}  &&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
...
\tiny Data Release  1   &    \tiny Jun 2026 -- Nov 2026 
        &&&&&&   % 2024
   & & &&&&&&&&&&   % 2025
   & & &&& \cellcolor{TLOrange3} & \cellcolor{TLOrange3} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2}    % 2026
...
\tiny Data Release  2   &    \tiny Jun 2027 -- Nov 2027           
   ...
   & & &&&&&&&&&&   % 2025
   &  & &&&&&&&&&&   % 2026
   & & &&& \cellcolor{TLOrange3} & \cellcolor{TLOrange3} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2}    % 2027
   &  \cellcolor{TLOrange3} & &&&&&&&&&&   % 2028
\\\hline
\tiny Data Release  3   &    \tiny Jun 2028 -- Nov 2028      
        &&&&&&   % 2024
   & & &&&&&&&&&&   % 2025
   & & &&&&&&&&&&   % 2026
   & & &&&&&&&&&&   % 2027
   & & &&& \cellcolor{TLOrange3} & \cellcolor{TLOrange3}  & \cellcolor{TLOrange2} & \cellcolor{TLOrange2} & \cellcolor{TLOrange2}  & \cellcolor{TLOrange3}  &  \cellcolor{TLOrange3} &   % 2028
