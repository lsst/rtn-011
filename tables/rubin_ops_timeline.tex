 ...
 \textbf{Event}  &  \textbf{Date Range}
   %  & \multicolumn{12}{c|}{\textbf{2024}}
     ...
     & \multicolumn{12}{c|}{\textbf{2028}}
           \\ \hline
\tiny  Data Preview 0.1/2/3  (DP0)&  \tiny   30 Jun 2023
     &&&&&&&&&&&&  
     &&&&&&&&&&&& 
     &&&&&&&&&&&&       
     &&&&&&&&&&&&     
\\\hline
\tiny Rubin  First Light  (RFL)    &    \tiny  23 June 2025      
...
\\\hline
%
\tiny Start of Operations (OPS)    &    \tiny  26 Oct 2025      
     &   &&&& &  &  &   & &  \cellcolor{RubinDarkTeal}  &&   % 2025 
     & & &&&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
...
\tiny Rubin First Alerts  (RFA)   &    \tiny  Nov 2025 -- Jan 2026     `
   &   &  & &    & & &    &  &  && \cellcolor{TLOrange3} &   \cellcolor{TLOrange2}% 2025
     & \cellcolor{TLOrange3}  & &&&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline

\tiny Start of LSST    (SVY)     &    \tiny Not before Jan 2026     
     &   &&&& &  &  &   & &    &   &  % 2025 
    &  \cellcolor{TLOrange3} &  \cellcolor{TLOrange2} & \cellcolor{TLOrange2}  &\cellcolor{TLOrange3}   &\cellcolor{TLOrange3}  & &&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
%
\tiny Start of Nightly PVIs \& Catalogs (NPC)  &  Not before April 2026   
     &   &&&& &  &  &   & &   &  &    % 2025 
...
\\\hline
%
\tiny PPDB Release (PPDB) &  Not before July 2026   
     &   &&&& &  &  &   & &   &  &    % 2025 
 & &&  && & &\cellcolor{TLOrange2} &\cellcolor{TLOrange3}  &\cellcolor{TLOrange3} &&&   % 2026
      & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
\\\hline
\tiny Data Release  1 (DR1)  &    \tiny Jan 2028 -- June 2028  
   & & &&&&&&&&&&   % 2025
   &  & &&&&&&&&&&   % 2026
   & & &&& & && &  &  &    % 2027
   &  & \cellcolor{TLOrange3}   & \cellcolor{TLOrange3}  &  \cellcolor{TLOrange2} &  \cellcolor{TLOrange3}& \cellcolor{TLOrange3}&&&&&&&   % 2028
