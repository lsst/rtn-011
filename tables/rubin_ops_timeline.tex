...
\tiny Start of LSST    (SVY)     &    \tiny Oct 2025 -- Nov 2025      
...
\tiny Start Early Prompt Products (EPP)  &    \tiny  Oct 2025 -- Nov 2025      
     &   &&&& &  &  &   &  &  \cellcolor{TLOrange2}  & \cellcolor{TLOrange3}  &   % 2025 
     & & &&&&&&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
...
%
%\tiny Start Regular Alert Production (RAP)  &    \tiny  Oct 2025 -- Nov 2025      
%     &   &&&& &  &  &   &  &   &  &   % 2025 
%     & & & \cellcolor{TLOrange2}  &&&&&&&&&   % 2026
%     & & &&&&&&&&&&   % 2027
%     & & &&&&&&&&&&   % 2028
%\\\hline
...
\tiny Start Regular  Prompt Products (RPP)  &    \tiny  Apr 2026 -- Jun 2026      
     &   &&&& &  &  &   & & &   &   % 2025 
     & & & & \cellcolor{TLOrange3} &  \cellcolor{TLOrange2}  & \cellcolor{TLOrange3}  &&&&&&   % 2026
     & & &&&&&&&&&&   % 2027
     & & &&&&&&&&&&   % 2028
...
\tiny Data Release  1 (DR1)  &    \tiny Oct 2026 -- Feb 2027      
   & & &&&&&&&&&&   % 2025
   & & &&& & &  && & \cellcolor{TLOrange3} & \cellcolor{TLOrange3} & \cellcolor{TLOrange2}    % 2026
   & \cellcolor{TLOrange2}  & \cellcolor{TLOrange3}  & &&&&&&&&&   % 2027
   & & &&&&&&&&&&   % 2028
\\\hline

\tiny Data Release  2 (DR2)  &    \tiny Oct 2027 -- Feb 2028      
   & & &&&&&&&&&&   % 2025
   &  & &&&&&&&&&&   % 2026
   & & &&& & && & & \cellcolor{TLOrange3} & \cellcolor{TLOrange3}   % 2027
   & \cellcolor{TLOrange2}   & \cellcolor{TLOrange2}  &  \cellcolor{TLOrange3} & &&&&&&&&&   % 2028
\\\hline
\tiny Data Release  3 (DR3)  &    \tiny Oct 2028 -- Dec 2028      
   & & &&&&&&&&&&   % 2025
   & & &&&&&&&&&&   % 2026
   & & &&&&&&&&&&   % 2027
