...
The survey began with an initial area of approximately 3,000~deg$^{2}$ (the ``3k'' region), following the ecliptic plane from dense regions of the Galactic Bulge through low-dust regions of the planned LSST Wide-Fast-Deep footprint.
