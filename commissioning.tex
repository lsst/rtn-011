...
As a result, the visit count and coadded depth increase substantially toward the inner regions of the footprint: the wide SV (3K) 3,000~deg$^{2}$ region reaches a median of 38 visits across all bands and an estimated coadded depth of $m_5\approx$ 25.0, the 750 deg$^{2}$ subset reaches 56 visits and $m_5\approx$ 25.8, and the 300 deg$^{\rm 2}$ core reaches 64 visits and $m_5$ \approx 25.7 (Table~\ref{tab:sv_wide_configs}).
...
the 300~deg$^{\rm 2}$ DP2 core approaches Year~1 depth in all bands, and the 3,000~deg$^{2}$ wide SV region reaches or exceeds Year~1 depth in some bands.
...
This milestone was formally declared on \lsststartdate.
