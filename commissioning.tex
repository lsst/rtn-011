...
A period of on-sky engineering time will be followed by a set of observations designed to help optimize the system, and finally (in the case of LSST Cam) a set of ``Science Validation'' (SV) surveys will be carried out.
