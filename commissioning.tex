...
Rubin Observatory commissioning was completed on \cstrcompdate, and the Observatory is now in an \emph{Early Operations Optimization} phase. Figure~\ref{fig:commissioning-es-schedule} presents the detailed schedule of completed commissioning and ongoing Early Science activities relative to the start of Operations.
\begin{figure}[htb]
\centering
