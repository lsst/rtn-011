...
The goal of the Early Optimization Phase is to bridge this gap: to bring the system to a state of operational readiness that supports start of the LSST. It is expected that optimization will continue even after the start of the LSST.
...
A start date for the LSST has not yet been determined but will be soon.
