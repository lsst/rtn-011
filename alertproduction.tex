...
Coadding multiple images enables artifact rejection  \citedsp{DMTN-080} and reduces noise.
...
Additionally, the LSST survey is heavily dithered, so without coadding many images onto a common sky plane it both difficult and inefficient to obtain image differences for a new pointing from past single images.
