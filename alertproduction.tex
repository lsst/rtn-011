...
Coadding multiple images enables artifact rejection  \citeds{DMTN-080} and reduces noise.
...
Rubin aims to scale up alert production during commissioning with the aim of  providing a ``near-live'' alert stream to the Brokers by the end of the LSSTCam SV surveys.
...
Given the desire to maximize the science harvest prior to the Data Release 1,  relaxing these criteria is an option to be explored.
