...
Alert packet contents for moving objects might not include the associated historical source records during the first phases of Alert Production, and parameters such as phase curve slope (G) and orbital elements would be empty until sufficient detections exist to derive them.
