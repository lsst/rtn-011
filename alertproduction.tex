...
Rubin aims to scale up alert production during commissioning with the aim of beginning routine Alert Production as soon as is feasible following the Rubin First Look (RFL) media event (\S~\ref{sec:timeline}).
...
Access to prompt PVIs and difference images in the first 6 months of the LSST is still to be decided. 
