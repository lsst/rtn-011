...
\item provide early integration tests of Rubin systems and prepare the team to be operations-ready.
\end{itemize}
...
DP0.1 and DP0.2 are already available via the Rubin Science Platform (RSP) running at the US Data Access Center (US DAC), hosted on the Google Cloud Platform.
