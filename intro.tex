...
\subsection{Transition to Operations and Early Science  } \label{ssec:scenarios}

The Operations team is tracking the progress of the commissioning activities (\S~\ref{sec:commissioning}) to identify opportunities for  Early Science and address the goals described in \S~\ref{sec:motivation}
...
\section{Additional Considerations for releasing data }
\label{sec:embargo}
