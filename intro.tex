...
\label{ssec:defn}
Early Science is defined as any science enabled by Rubin for its community during the period from the beginning of commissioning through Data Release 1 (DR1).
...
The following night, the observatory began on-sky operations for the Early Operations phase. 
...
These early data products are derived from data obtained during commissioning (\S~\ref{sec:commissioning}), Early Operations, and the first year of LSST observations. 
...
\end{itemize}
Of the above, only the 80-hour embargo on all pixel data remains active, and will do for the duration of Rubin Operations. 
