...
Consequently, while the Operations team will do its best to deliver the maximum of early data, data product types and services, all indications on the contents of the Data Previews, early Alert Stream and supporting services are subject to change up until their release date. 

In January 2025, <following guidance from the agencies> and based on the progress of Rubin commissioning, the planned commissioning Science Validation (SV) surveys were transferred to Operations. 
...
The same planned SV surveys will then be executed during the first 2 months of Rubin Operations prior to commencing the 10-year LSST. 
...
The subset of System First Light observations that form the basis of DP1 must be taken and analysed in order to support construction completeness
...
Execution of the  SV surveys in ops will also serve as a full dress rehearsal for the team to ensure readiness. 
...
\item the security review, which must be successfully completed prior to the release of any <> data; 
\item The First Look media event, before which release of any data is embargoed
\end{itemize}
 
The term \textit{stretch goal} will be used in cases where uncertainty is due to a technical consideration and \textit{To Be Decided (TBD)} will be used when the influencing factor is of a policy nature. 
