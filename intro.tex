...
\item A construction security review must be successfully completed prior to the release of any Prompt data products;
\item The Rubin First Look (RFL) media event, \citeds{rtn-083},  currently expected in June 2025. No Rubin image data may be released before this event. 
\end{itemize}
