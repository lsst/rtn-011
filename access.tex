...
A number of Rubin Independent Data Access Centers (IDACs) is also under construction to provide additional user computing resources to LSST users around the globe (\citeds{RTN-003}).
