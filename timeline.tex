...
The shaded region contains roughly 80\% of the probability, while the left-hand edge of the shaded range indicates the earliest date the milestone could be reached.
...
The next key milestones in the Early Science Program are the start of LSST alerts in late 2025, followed by the start of the LSST in early 2026. 
