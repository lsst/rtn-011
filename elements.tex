...
A detailed description of the Alert Production is given in \S~\ref{sec:prompt-products}
...
Details of the current strategy for alert generation  with incremental templates are given in \S~\ref{ssec:ap}.
