...
%		\item Incremental generation of templates during the first year of survey operations to steadily increase Alert Production and distribution to Community Brokers over the course of the first year of the survey.
	\item LSST Data Release 1 (DR1), which will be based on the Data Release Processing (DRP) of the first six months of LSST data.
\end{itemize}

% Data Previews
% This provides early integration tests of our system, prepare the team to be operations-ready, and prepare the community to use Rubin data products and services
...
% LSSTCam Science Validation Surveys (SV Surveys) respectively, together with any additional science-quality data taken throughout the full commissioning period.
